...
<head>
    ...
    <script src="https://maps.gomaps.pro/maps/api/js?key=AlzaSynmZW_vMba1xG0XTelodXSsqyVDvWDQGO&libraries=places&callback=initAutocomplete" async defer></script>
    <style>
        /* Global Reset */
        * {
            margin: 0;
...
<body>
    ...
    <div class="container">
        ...
        <form action="submit_load.php" method="POST" id="loadForm">
