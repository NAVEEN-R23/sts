...
<head>
    ...
    <script src="https://maps.gomaps.pro/maps/api/js?key=AlzaSynmZW_vMba1xG0XTelodXSsqyVDvWDQGOr&libraries=places&callback=initAutocomplete" async defer></script>
    <style>
        /* Global Reset */
        * {
            margin: 0;
